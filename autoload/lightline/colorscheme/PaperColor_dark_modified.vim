...
let s:p.normal.left = [ [ s:red, s:background ], [ s:statusline_active_fg, s:status ], [ s:statusline_active_fg, s:statusline_active_bg ] ]
...
let g:lightline#colorscheme#PaperColor_dark_modified#palette = lightline#colorscheme#fill(s:p)
